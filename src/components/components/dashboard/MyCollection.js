...
function MyCollection(props) {
    ...
    useEffect(() =>  {
        (async () => {
            try {
                await Moralis.start({appId: 'kHfSntBY6Lu5iWCCPF4HaHCf6PDTXxuYbiEq9YBx', serverUrl: 'https://lyd7qxufgy7q.usemoralis.com:2053/server'});
                if(!account) return
                const response = await Web3API.account.getNFTs({address: account});
